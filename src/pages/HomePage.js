...
import { WIDGET_URL, X_URL, DISCORD_URL } from "../data/constants";
...
function HomePage({ onNavigate }) {
  ...
  useEffect(() => {
    document.title = "Coinporate | Business Tokenization Platform on Solana";
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute(
        "content",
        "Coinporate is a platform in development enabling verified businesses to tokenize their brands. Powered by the CORP token on Solana."
      );
    } else {
        ...
        <div className="platform__inner">
          <div className="platform__split">
            <div className="platform__text">
              <h3 className="platform__title">Coinporate is a Web3 platform</h3>
            ...
            <PlatformShot
              ...
              titles={["Platform Explorer", "Project Overview"]}
              descriptions={[
                "Browse and interact with verified token-enabled projects",
                "View project details, activity, and participation features",
              ]}
          ...
          <div className="platform__split platform__split--reverse">
            <div className="platform__text">
              <h3 className="platform__title">Token detail & participation</h3>
              <p className="platform__copy">
              ...
              <p className="platform__copy">
                ...
                placing token data, project context, and interaction mechanisms
                in a single, transparent workflow.
              </p>
              <PrimaryButton className="btn--pill platform__cta" type="button">
                <span className="btn__icon" aria-hidden="true">
                  <img
                    src={require("../assets/coinporate/svgs/star.svg").default}
                    alt=""
            ...
            <PlatformShot
              ...
              titles={["Project Interface", "Token Detail View"]}
              descriptions={[
                "Explore token-based project environments and tools",
                "Review token data, project context, and on-chain interactions",
              ]}
      ...
      <section className="liquidity">
        <div className="liquidity__inner">
          ...
          <div className="liquidity__carousel embla" ref={liquidityEmblaRef}>
            <div className="liquidity__track embla__container">
              {liquidityCards.map((card, index) => (
                <div key={card.title} className="liquidity__slide embla__slide">
                  <LiquidityCard
                    icon={card.icon}
                    title={card.title}
                    text={card.text}
          ...
          >
            ...
            <span className="btn__label">Join the Exclusive CORP Presale</span>
